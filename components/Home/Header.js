...
export default function Header() {
  return (
    <div className="bg-gradient-to-b from-gray-50 to-gray-100 -z-10 pt-20 pb-24 w-screen">
      <div className='w-11/12 md:w-10/12 lg:w-8/12 px-4 mx-auto'>
        <div className='grid grid-cols-12 justify-items-start items-center'>
          <div className="move-text-up order-2 md:order-1 col-span-12 md:col-span-6 lg:col-span-7 mx-4">
            ...
            <h2 className="text-3xl md:text-2xl text-black mt-2">Web design and development portfolio</h2>
          ...
          <div className="order-1 md:order-2 col-span-12 md:col-span-6 lg:col-span-5 sm:justify-self-center justify-self-end md:justify-self-end md:my-10">
            <div className="bg-white border-2 border-gray-50 rounded-full w-[330px] h-[330px] shadow-2xl z-0 relative">
              ...
              <div className='absolute -top-[14%] -left-[14.5%] head-appear'>
                <div id="img-spin-container">
                  <div className="img-spin shadow-lg pt-[2px]"><Image src="/github_octokitty.svg" width={100} height={70} /></div>
                  <div className="img-spin shadow-lg pt-[2px] pr-[2px]"><Image src="/javascript_logo.svg" width={30} height={46} /></div>
                  <div className="img-spin shadow-lg pt-[2px]"><Image src="/react.svg" width={100} height={70} /></div>
                  <div className="img-spin shadow-lg"><Image src="/nextjs_logo.svg" width={40} height={50} /></div>
                  <div className="img-spin shadow-lg pt-[2px]"><Image src="/nodejs_logo.svg" width={100} height={70} /></div>
                  <div className="img-spin shadow-lg pt-[2px] pr-1"><Image src="/strapi_logo.svg" width={100} height={70} /></div>
                  <div className="img-spin shadow-lg pt-[2px]"><Image src="/graphql.svg" width={100} height={70} /></div>
                  <div className="img-spin shadow-lg pt-[2px]"><Image src="/tailwind.svg" width={100} height={70} /></div>
                </div>
              </div>
            </div>
          </div>
