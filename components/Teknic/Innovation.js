    ...
    <div className="bg-white pb-36">
      <div className='sm:w-11/12 md:w-10/12 mx-auto px-4'>
        <div className='mx-auto text-center pt-36'>
          ...
          <h1 className="text-6xl font-bold text-teknic-blue mt-6">Innovation at Every Turn</h1>
        ...
        <div className="grid grid-cols-12 lg:grid-cols-12 place-items-center max-w-5xl mx-auto mt-24">
          <div className="order-2 lg:order-1 col-span-12 lg:col-span-5 lg:pr-12 mt-12 lg:mt-0">
            ...
            <h3 className="font-bold text-3xl text-black mt-2">Inertia Matching</h3>
            ...
            <div className='rounded-full bg-[#FF0000] shadow-lg shadow-white border-2 border-white hover:bg-[#fff] hover:text-[#ff0000] hover:border-2 hover:border-[#ff0000]/30 hover:shadow-lg hover:shadow-[#ff0000]/40 text-white text-md font-semibold w-32 text-center py-2 mt-4 hover:cursor-pointer transition duration-300 ease-in-out hover:scale-110'>
              Demo&nbsp;&nbsp;
        ...
        <div className="grid grid-cols-12 lg:grid-cols-12 place-items-center max-w-5xl mx-auto mt-24 -mb-12">
          <div className="order-2 lg:order-2 col-span-12 lg:col-span-5 lg:pl-12 -mt-20">
          ...
          <div className="order-1 lg:order-1 col-span-12 lg:col-span-7 w-full pt-10">
            <RAS />
          </div>
        </div>
        ...
        <div className="grid grid-cols-12 lg:grid-cols-12 place-items-center max-w-5xl mx-auto mt-28">
          <div className="order-2 lg:order-2 col-span-12 lg:col-span-5 lg:pl-14 mt-12 lg:-mt-2">
          ...
          <div className="order-1 lg:order-1 col-span-12 lg:col-span-7 relative">
            <GStopAnim />
          </div>
        </div>
